      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (newUser.data.status === 'Success') {
            (0, _alert.showAlert)('success', 'Mail is send to your inbox');
          }
          _context.next = 11;
          break;
        case 8:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addSubjects.js":[function(require,module,exports) {
"use strict";
...
var addData = exports.addData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(subject, totalNumLecture) {
    var subjects;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            data: {
              subject: subject,
              totalNumLecture: totalNumLecture
            }
          });
        case 3:
          subjects = _context.sent;
          console.log(subjects);
          (0, _alert.showAlert)('success', 'Subject Added Successfully');
          window.setTimeout(function () {
            location.assign('/subjectsOverview');
          }, 1500);
          _context.next = 12;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"markAttendance.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var markAttendance = exports.markAttendance = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(holiday, date, isPresent, studentId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _axios.default)({
            url: "http://127.0.0.1:3000/api/v2/subject/markAttendance/".concat(studentId),
            method: 'POST',
            data: {
              holiday: holiday,
              date: date,
        ...
        case 3:
          res = _context.sent;
          console.log(res);
          (0, _alert.showAlert)('success', 'Attendance Marked 😄😄');
          window.setTimeout(function () {
            location.assign('/subjectsOverview');
          }, 1500);
          _context.next = 12;
  ...
  return function markAttendance(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.updateStudentPassword = exports.updateStudentData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var updateStudentData = exports.updateStudentData = /*#__PURE__*/function () {
  ...
  return function updateStudentData(_x) {
    return _ref.apply(this, arguments);
  };
}();
var updateStudentPassword = exports.updateStudentPassword = /*#__PURE__*/function () {
  ...
  return function updateStudentPassword(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateSubjectData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateSubjectData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var updateSubjectData = exports.updateSubjectData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(subjectId, date, newHoliday, newIsPresent) {
    var updateData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v2/subject/updateAttendance/".concat(subjectId, "/").concat(date),
        ...
        case 3:
          ...
          (0, _alert.showAlert)('success', "Attendance Updated Successfully");
          window.setTimeout(function () {
            location.assign('/subjectsOverview');
          }, 1500);
          _context.next = 11;
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)('error', "Error while Updating");
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function updateSubjectData(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"delete.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteSubjectData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deleteSubjectData = exports.deleteSubjectData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(subjectId) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3000/api/v2/subject/deleteSubject/".concat(subjectId)
          });
        case 3:
          response = _context.sent;
          console.log(response);
          (0, _alert.showAlert)('success', 'Subject Deleted Successfully');
          window.setTimeout(function () {
            location.assign('/subjectsOverview');
          }, 1500);
          _context.next = 12;
  ...
  return function deleteSubjectData(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _addSubjects = require("./addSubjects");
var _markAttendance = require("./markAttendance");
var _updateSetting = require("./updateSetting");
var _updateSubjectData = require("./updateSubjectData");
...
var addSubjectForm = document.querySelector('#add_form');
var markAttendanceForm = document.getElementById('markAttendance_form');
var updateAttendanceForm = document.getElementById('updateAttendance_form');
var updateData = document.querySelector('.form-user-data');
var deleteSubject = document.getElementById('deleteSubjectForm');
var newPassword = document.querySelector('.form-user-password');
if (updateData) {
  updateData.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.updateStudentData)(form);
  });
}
if (loginForm) {
...
if (addSubjectForm) {
  addSubjectForm.addEventListener('submit', function (e) {
    ...
    var totalNumLecture = document.getElementById('email').value;
    (0, _addSubjects.addData)(subject, totalNumLecture);
  });
}
if (markAttendanceForm) {
  markAttendanceForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var holiday = document.getElementById('name').value;
    var date = document.getElementById('email').value;
    var isPresent = document.getElementById('isPresent').value;

    // Get the current URL

    var isPresentModified = isPresent === 'Present' || isPresent === 'present' ? true : false;
    var holidayModified = holiday === 'Yes' || isPresent === 'yes' ? true : false;
    var dateModified = new Date(date);
    var currentURL = window.location.href;

    // Use regular expressions to extract the subjectId from the URL
    var subjectId = currentURL.match(/\/markAttendance\/([^/]+)/)[1];
    console.log(holidayModified, dateModified, isPresentModified, subjectId);
    (0, _markAttendance.markAttendance)(holidayModified, dateModified, isPresentModified, subjectId);
  });
}
if (updateAttendanceForm) {
  updateAttendanceForm.addEventListener('submit', function (e) {
    ...
    var isPresentModified = isPresent === 'Present' || isPresent === 'present' ? true : false;
    var holidayModified = holiday === 'Yes' || holiday === 'yes' ? true : false;
    var currentURL = window.location.href;

    // Use regular expressions to extract the subjectId from the URL
    var subjectId = currentURL.match(/\/updateAttendance\/([^/]+)/)[1];
    var date = currentURL.match(/\/updateAttendance\/[^/]+\/([^/]+)/)[1];
    (0, _updateSubjectData.updateSubjectData)(subjectId, date, holidayModified, isPresentModified);
  });
}
if (newPassword) {
  newPassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var existingPassword, password, confirmPassword;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            existingPassword = document.querySelector('#password-current').value;
            password = document.querySelector('#password').value;
            confirmPassword = document.querySelector('#password-confirm').value;
            _context.next = 6;
            return (0, _updateSetting.updateStudentPassword)(existingPassword, password, confirmPassword);
          case 6:
